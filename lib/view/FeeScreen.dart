      ...
      if (_myActivities.length == 1) {
        ...
        if (mon == "Nữa tháng" || mon == "Miễn phí") {
          ...
          if (int.parse(monthFee) < month) {
            ...
            String currentDate = DateFormat('yyyy').format(now);

              if(currentDate != _listSearchs[i].address.toString()){
                RegisterData registerData = new RegisterData();
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          if(name.toString().contains("admin") || name.toString().contains("qc")){
                            ...
                            String message = "CLB Karate xin thông báo võ sinh: " +_listSearchTemp[index].name + " đã đến hạn thanh toán học phí. " + "Quý phụ huynh vui lòng thanh toán. Xin cảm ơn.";
